...
const showToDoForm = (
    ...
    if (existingTitle) {
        titleInput.setAttribute('value', existingTitle)
    }
    ...
    if (existingDescription) {
        descriptionInput.setAttribute('value', existingDescription)
    }
    ...
    if (existingDueDate) {
        dateInput.setAttribute('value', existingDueDate)
    }
    ...
    if (existingPriority === 'Low priority') {
    ...
    if (existingPriority === 'Medium priority') {
        priorityInputMedium.setAttribute('checked', '')
    }
    ...
    if (existingPriority === 'High priority') {
        priorityInputHigh.setAttribute('checked', '')
    }
...
const editToDo = (todoDOM, title, description, dueDate, priority) => {
    ...
    const descriptionDOM = todoDOM.querySelector('.todo-description')
    descriptionDOM.innerHTML = description
...
export { showToDoForm, renderToDo, expandToDo, editToDo, toggleTodoStatusClass }
